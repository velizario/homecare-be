...
exports.seedEstateSizeData = exports.seedHourDayData = exports.seedOrderStatusData = exports.seedWeekDayData = exports.seedVisitFrequencyData = exports.seedDistrictNameData = exports.seedServiceTypeData = exports.IMAGE_PATH = void 0;
const path_1 = __importDefault(require("path"));
const Entities_1 = require("../entity/Entities");
exports.IMAGE_PATH = path_1.default.join(path_1.default.resolve(__dirname).split("\\src\\")[0], "public");
exports.seedServiceTypeData = [
    {
        id: 1,
...
exports.seedVisitFrequencyData = [
    { id: 0, value: "Еднократно" },
    { id: 1, value: "Седмично" },
    { id: 2, value: "Двуседмично" },
];
exports.seedWeekDayData = [
...
exports.seedOrderStatusData = [
    { id: Entities_1.ORDER_STATUS.NEW, value: "Нова" },
    { id: Entities_1.ORDER_STATUS.OFFER, value: "Оферта" },
    { id: Entities_1.ORDER_STATUS.RESERVATION, value: "Резервация" },
    { id: Entities_1.ORDER_STATUS.ACTIVE, value: "Активна" },
    { id: Entities_1.ORDER_STATUS.CANCELLED, value: "Анулирана" },
    { id: Entities_1.ORDER_STATUS.COMPLETE, value: "Завършена" },
    { id: Entities_1.ORDER_STATUS.PASSED, value: "Изминала" },
];
exports.seedHourDayData = [
